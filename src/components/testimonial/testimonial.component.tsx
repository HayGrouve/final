...
export default function Testimonial() {
  return (
    <div id="CEO" className="bg-white pt-24 pb-16 sm:pt-32 sm:pb-24 xl:pb-32">
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-y-10 gap-x-8 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <button
                type="button"
                className="mt-3 rounded-md bg-green-700 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700"
              >
                Not convinced yet?
              </button>
              <figcaption className="mt-8 text-base">
                <div className="font-semibold text-white">Tsvetomir Tsekov</div>
                <div className="mt-1 text-gray-400">CEO of Sport Predict</div>
              </figcaption>
            </figure>
          </div>
        </div>
